...
async function checkForUpdate(
  ...
  console.log(config, "configconfigconfigconfig12321312");
  console.log(localPackage, "localPackagelocalPackagelocalPackage");
  console.log(NativeCodePush, "NativeCodePushNativeCodePushNativeCodePush");
  /*
  ...
  console.log(queryPackage, "queryPackagequeryPackagequeryPackagequeryPackage");
  ...
  if (
    ...
    console.log(remotePackage, "remotePackageremotePackageremotePackage");
...
const getConfiguration = (() => {
  ...
  return async function getConfiguration() {
    if (config) {
      ...
      console.log("🚀 CodePush Config:", config); // Debug log
      return config;
    }
  };
})();
...
async function getUpdateMetadata(updateState) {
  ...
  console.log("🔍 Current Package Metadata:", updateMetadata);
  if (updateMetadata) {
...
function getPromisifiedSdk(requestFetchAdapter, config) {
  ...
  console.log("🚀 CodePush SDK Config:", config);
