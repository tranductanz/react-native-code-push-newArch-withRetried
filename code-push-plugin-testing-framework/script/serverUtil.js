...
function setupServer(targetPlatform) {
  ...
  app.use(function (req, res, next) {
    ...
    res.setHeader(
      ...
      "origin, content-type, accept, X-CodePush-SDK-Version"
    );
    next();
  });
...
var TestMessage = (function () {
  ...
  TestMessage.SKIPPED_NOTIFY_APPLICATION_READY =
...
var TestMessageResponse = (function () {
  ...
  TestMessageResponse.SKIP_NOTIFY_APPLICATION_READY =
